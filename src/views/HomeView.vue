<template>
  <div id="home">
      ...
      <div class="principal-right-container">
          <img class="img-system-mockup" src="https://i.ibb.co/g64NzdV/image.png" alt="image">
      </div>
  </div>
</template>
<script>
...
.principal-left-container {
  display: flex;
  width: 32rem;
  padding: 4.5rem 1.5625rem 4.5rem 1.625rem;
